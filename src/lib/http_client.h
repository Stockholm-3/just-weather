...
typedef struct
{
    ...
    TCPClient* tcp_conn;  // Handle to TCP connection, är en tcp connection struct
...
http_client_state http_client_work_reading(http_client* _Client);  // THIS WAS MISSING
